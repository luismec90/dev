...
@section('css')
{{ HTML::style('assets/themes/one/css/custom.css') }}
@stop

@section('content')


<h2 class='titulo'>{{ $shop->name }}</h2>
...
<div class="row">
            ...
            <div class="col-lg-12">
                ...
                <ul id="myTab" class="nav nav-tabs nav-justified">
                    <li class="active"><a href="#service-one" data-toggle="tab"><i class="fa fa-support"></i> Cutsom section</a>
                    </li>
                    <li class=""><a href="#service-two" data-toggle="tab"><i class="fa fa-support"></i> Mision</a>
                    </li>
                    <li class=""><a href="#service-three" data-toggle="tab"><i class="fa fa-support"></i> Visión</a>
                    </li>
...
<div class="row">
    <div class="col-lg-12">
        <h2 class="page-header">Lo más destacado</h2>
    </div>
