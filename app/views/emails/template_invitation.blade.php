                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="600" style="border: 1px solid #cccccc; border-collapse: collapse;">
                        <tr>
                            <td align="center" bgcolor="#ee4c50" style="padding: 40px 0 30px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                                <img src="http://linkingshops.com/assets/images/logo-white.png" width="50" height="50" style="margin-right: 10px"><label style=" color:#fff; font-size: 53px;"> LinkingSh<img src="http://linkingshops.com/assets/images/loading-white.gif" width="40" height="40">ps </label>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <tr>
                                        <td style="color: rgb(102, 102, 102); font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 15px; font-weight: 300;line-height: 20px;">
                                            ...
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td style="padding: 0">
                                                        <img src="http://linkingshops.com/assets/images/logo.png" height="60" style="margin-right: 10px">
                                                    </td>
                                                    <td style="padding: 0">
                                                        <table border="0" cellpadding="0" cellspacing="0" style="margin-left: 5px;">
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0">
                                                                    Gerente comercial, LinkingShops.
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td style="padding: 0">
                                                                    E-mail: gerencia@linkingshops.com
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
