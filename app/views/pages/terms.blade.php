...
<section class="section  section-cta">
    <div class="container">
        <h1 class="section-title"><span>Términos y Condiciones de Uso</span></h1>
        <div class="row">
            <div class="col-xs-12">
                <h3>1. La aceptación por parte de los Usuarios</h3>
                <p>LinkingShops, se reserva el derecho a exigir que cada usuario, acepte y cumpla los términos aquí expresados como condición previa y necesaria para el acceso, y utilización de los servicios y/o contenidos brindados por el Sitio.</p>
