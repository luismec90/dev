                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="checkbox">
                                    <label>
                                        <h4> {{ Form::checkbox('checkbox-shop', 'true', true, ['id' => 'checkbox-shop']); }}
                                            Deseo registrar un establecimiento comercial </h4>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="checkbox">
                                    <label>
                                        {{ Form::checkbox('checkbox-terms', 'true', false, ['id' => 'checkbox-terms','required'=>true]); }}
                                        Acepto los <a class="link" href="{{ route('terms_path') }}" target="_blank">Términos
